...
$stmt = $con->prepare("SELECT lawyer_first_name, lawyer_last_name, lawyer_city, lawyer_address,lawyer_phone_no, lawyer_rating, specialization,lawyer_image,lawyer_email from lawyer_login WHERE lawyer_id = ?");
$law=$_SESSION['lawyer_id'];
$stmt->bind_param('s',$law );
$stmt->execute();
$stmt->store_result();
$stmt->bind_result($fname, $lname, $city, $address,$phone, $rating, $special, $img_type,$email);
$stmt->fetch();
